...
# 2. CONNECT TO SHEET USING UNIQUE ID
# Replace 'YOUR_SPREADSHEET_ID_HERE' with the long code from your URL
    ...
    if st.button("Create My Shop"):
        if raw_vendor and new_pin and new_bank:
            ...
            try:
                ...
                st.error("Sheet already exists or name invalid.")
        else:
...
with app_mode[0]:
    ...
    active_vendors = [r["Vendor Name"] for r in records if r["Vendor Name"]]
